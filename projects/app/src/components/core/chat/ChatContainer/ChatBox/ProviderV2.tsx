...
import { getChatResDataV2 } from '@/web/core/chat/api';
import { ChatItemContext } from '@/web/core/chat/context/chatItemContext';
import { ChatRecordContext } from '@/web/core/chat/context/chatRecordContextV2';
  ...
  const getHistoryResponseData = useCallback(
    async ({ dataId }: { dataId: string }) => {
      ...
      if (!!aimItem?.responseData || !chatId) {
        ...
        let resData = await getChatResDataV2({
          appId: appId,
          chatId: chatId,
          dataId,
          ...outLinkAuthData
